...
public class PilhaMain{
    ...
    public static void main(String[] args){
        ...
        PilhaSeq pilhaPersonagem = new PilhaSeq(); //Inicializa Lista
     ...
     */
    public static void operaPilha(PilhaSeq pilhaPersonagens, int numOp){
        Personagem p;
...
class PilhaSeq {
    ...
    /**
     * Cria pilha de tamanho determinado pelo usuario
     * @param tamMax
     */
    PilhaSeq(int tamMax){
        this.tamMax = tamMax;
        this.numItens = 0;
        this.pilha = new Personagem[tamMax];
    }

    /**
     * Realiza insercao na pilha
     * @param dado Dado a ser inserido
     * @throws Exception MAX_RECHEAD - Pilha Cheia
     */
    public void empilha(Personagem dado) throws Exception{
    ...
    /**
     * Recupera dado presente no topo da pilha
     * @return Dado recuperado
     * @throws Exception LISTA_VAZIA
     */
    public Personagem desempilha() throws Exception{
        Personagem dadoRecuperado = null;

        if(numItens != 0){
            dadoRecuperado = pilha[numItens - 1];
            numItens--;
        }else{
    ...
    /**
     * Realiza Impressao de dados presentes na pilha
     */
    public void imprime(){
        Personagem p;
