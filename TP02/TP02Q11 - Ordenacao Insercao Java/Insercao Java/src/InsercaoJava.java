/**
 * @file InsercaoJava.java
 * @author 784778 - Wallace Freitas Oliveira (https://github.com/Olivwallace)
 * @brief TP02Q11 - Algoritmo e Estruturas de Dados II (PUC-Minas 1°/2023)
 * @date 25-03-2023
 */
...
public class InsercaoJava {
    ...
    private static final File arq = new File(matricula + "_insercao.txt");
...
class ListaSeq {
    ...
    /**
     * Ordena lista através de insercao
     */
    public void insercaoSort(){
        ...
        for(int i = 1; i < numItens; i++){
            ...
            personagem = lista[i];
            atual =  personagem.getAnoNascimento();

            while(j >= 0 && atual.compareTo(lista[j].getAnoNascimento()) < 0) {
                logSort[0]++; logSort[1]++;
                lista[j + 1] = lista[j];
                j--;
            }

            lista[j + 1] = personagem;
            logSort[1]++;
